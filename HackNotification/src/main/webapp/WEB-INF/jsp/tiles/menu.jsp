				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="${pageContext.request.contextPath}/admin/getusercities"><i class="fa fa-dashboard fa-fw"></i>
								Cities</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/attributetypelist"><i class="fa fa-dashboard fa-fw"></i>
								Attribute Type</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/addproduct"><i class="fa fa-dashboard fa-fw"></i>
								Post Ad</a></li>
